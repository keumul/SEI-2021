...
#define LICH_DEFAULT 0x00000000				//значение по умолчанию для valeur
#define STR_DEFAULT	0x00					//значение по умолчанию для entier
...
#define VAL_MAXSIZE 32767					//максимальное значение для типа valeur
#define VAL_MINSIZE -32768					//минимальное значение для типа valeur
...
namespace IT
{
	enum IDDATATYPE { ENT = 1, STR = 2, LECT = 3, UNDEF };//типы данных идентификаторов: числовой, строковый, без типа(для процедур), неопределенный
